                    ...
                    <div class="row" style="height:100%;">
                        <div class="col-md-12" style="height: 100%;">
                            <div class="upload-desc">
                                <h4><b>Konfirmasi Pembayaran DP</b></h4>
                                <form method="post" action="process.php?process=upload-slip-dp" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="id_trans">Kode Sewa : </label>
                                        <input type="text" class="form-control" id="id_trans" name="id_trans" placeholder="Masukkan Kode Sewa" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="upload_img">Upload Screenshot Bukti Pembayaran DP : </label>
                                        <input type="file" class="form-control" id="upload_img" name="upload_img" accept="image/*" required>
                                    </div>
